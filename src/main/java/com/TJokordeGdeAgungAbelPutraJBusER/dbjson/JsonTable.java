    ...
    public JsonTable(Class<T> clazz, String filepath) throws IOException {
        ...
        try {
            ...
            if (loaded != null) {
                ...
                int lastId = 0;
                for (T item : this) {
                    if (item instanceof com.TJokordeGdeAgungAbelPutraJBusER.Serializable) {

                        com.TJokordeGdeAgungAbelPutraJBusER.Serializable serializableItem = (com.TJokordeGdeAgungAbelPutraJBusER.Serializable) item;
